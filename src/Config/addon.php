    ...
    'frontend_templates' => [
        ...
        'manifest' => [
            'module' => [
                ...
                'deploy_entry' => env('PTADMIN_ADDON_FRONTEND_MODULE_DEPLOY_ENTRY', '{app_url}/{admin_web_prefix}/modules/{code}/dist/assets/remoteEntry.js'),
            ...
            'micro-app' => [
                ...
                'deploy_url' => env('PTADMIN_ADDON_FRONTEND_MICRO_APP_DEPLOY_URL', '{app_url}/{admin_web_prefix}/modules/{code}/dist/'),
            ],
        ],
        'templates' => [
            'module' => [
