...
final class AddonInitAction
{
    ...
    public function handle(string $title = '', bool $force = false): array
    {
        ...
        if ($this->filesystem->isDirectory($target)) {
            if (!$force) {
                throw new AddonException(__('ptadmin-addon::messages.command.init_exists', ['path' => $target]));
            }
            $this->filesystem->deleteDirectory($target);
        }

        $this->createDirectories($target);
        $this->writeManifest($target, $code, $title, $basePath);
        $this->writeInstaller($target, $basePath);
        $this->writeBootstrap($target, $basePath, $title, $code);
        $this->writeProvider($target, $basePath);
        $this->writeFunctions($target);
        $this->writeRoutes($target, $code);
        $this->writeConfig($target, $code, $title);
        $this->writeModel($target, $basePath);
        $this->writeService($target, $basePath, $title, $code);
        $this->writeDashboardWidget($target, $basePath, $title, $code);
        $this->writeControllers($target, $basePath, $title, $code);
        $this->writeViews($target, $title, $code);
        $this->writeReadme($target, $title, $basePath);
        $this->writeGitkeep($target.\DIRECTORY_SEPARATOR.'Assets'.\DIRECTORY_SEPARATOR.'.gitkeep');
        $this->writeGitkeep($target.\DIRECTORY_SEPARATOR.'Response'.\DIRECTORY_SEPARATOR.'Lang'.\DIRECTORY_SEPARATOR.'.gitkeep');
        $this->writeGitkeep($target.\DIRECTORY_SEPARATOR.'Http'.\DIRECTORY_SEPARATOR.'Requests'.\DIRECTORY_SEPARATOR.'.gitkeep');
        $this->writeGitkeep($target.\DIRECTORY_SEPARATOR.'Database'.\DIRECTORY_SEPARATOR.'Migrations'.\DIRECTORY_SEPARATOR.'.gitkeep');
        $this->writeGitkeep($target.\DIRECTORY_SEPARATOR.'Database'.\DIRECTORY_SEPARATOR.'Seeders'.\DIRECTORY_SEPARATOR.'.gitkeep');

        $this->success(__('ptadmin-addon::messages.command.init_created', ['path' => $target]));
    ...
    private function writeManifest(string $target, string $code, string $title, string $basePath): void
    {
        $manifest = [
            'id' => $code,
            'code' => $code,
    ...
    private function writeInstaller(string $target, string $basePath): void
    {
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Installer.php', <<<PHP
<?php
...
PHP
    ...
    private function writeBootstrap(string $target, string $basePath, string $title, string $code): void
    {
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Bootstrap.php', <<<PHP
<?php
...
PHP
    ...
    private function writeProvider(string $target, string $basePath): void
    {
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Providers'.\DIRECTORY_SEPARATOR.$basePath.'ServiceProvider.php', <<<PHP
<?php
...
PHP
    ...
    private function writeFunctions(string $target): void
    {
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'functions.php', <<<PHP
<?php
...
PHP
    ...
    private function writeRoutes(string $target, string $code): void
    {
        $basePath = Str::studly($code);

        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Routes'.\DIRECTORY_SEPARATOR.'admin.php', <<<PHP
<?php
...
PHP
        ...
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Routes'.\DIRECTORY_SEPARATOR.'api.php', <<<PHP
<?php
...
PHP
        ...
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Routes'.\DIRECTORY_SEPARATOR.'web.php', <<<PHP
<?php
...
PHP
    ...
    private function writeConfig(string $target, string $code, string $title): void
    {
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Config'.\DIRECTORY_SEPARATOR.'config.php', <<<PHP
<?php
...
PHP
    ...
    private function writeModel(string $target, string $basePath): void
    {
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Models'.\DIRECTORY_SEPARATOR.$basePath.'.php', <<<PHP
<?php
...
PHP
    ...
    private function writeService(string $target, string $basePath, string $title, string $code): void
    {
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.$basePath.'Service.php', <<<PHP
<?php
...
PHP
    ...
    private function writeDashboardWidget(string $target, string $basePath, string $title, string $code): void
    {
        $serviceProperty = lcfirst($basePath).'Service';

        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Dashboard'.\DIRECTORY_SEPARATOR.$basePath.'OverviewWidget.php', <<<PHP
<?php
...
PHP
    ...
    private function writeControllers(string $target, string $basePath, string $title, string $code): void
    {
        $serviceProperty = lcfirst($basePath).'Service';

        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Http'.\DIRECTORY_SEPARATOR.'Controllers'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.$basePath.'Controller.php', <<<PHP
<?php
...
PHP
        ...
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Http'.\DIRECTORY_SEPARATOR.'Controllers'.\DIRECTORY_SEPARATOR.'Api'.\DIRECTORY_SEPARATOR.$basePath.'Controller.php', <<<PHP
<?php
...
PHP
        ...
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Http'.\DIRECTORY_SEPARATOR.'Controllers'.\DIRECTORY_SEPARATOR.'Home'.\DIRECTORY_SEPARATOR.$basePath.'Controller.php', <<<PHP
<?php
...
PHP
    ...
    private function writeViews(string $target, string $title, string $code): void
    {
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Response'.\DIRECTORY_SEPARATOR.'Views'.\DIRECTORY_SEPARATOR.'home'.\DIRECTORY_SEPARATOR.'index.blade.php', <<<BLADE
<div>
    <h1>{$title}</h1>
...
BLADE
        ...
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'Response'.\DIRECTORY_SEPARATOR.'Views'.\DIRECTORY_SEPARATOR.'ptadmin'.\DIRECTORY_SEPARATOR.'index.blade.php', <<<BLADE
<div>
    <h1>{$title} 后台</h1>
...
BLADE
    ...
    private function writeReadme(string $target, string $title, string $basePath): void
    {
        $this->filesystem->put($target.\DIRECTORY_SEPARATOR.'README.md', <<<MD
# {$basePath} Plugin
...
MD
    ...
    private function writeGitkeep(string $path): void
    {
